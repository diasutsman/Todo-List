...
display.addEventListener('click', (e) => {
    ...
    // (Save Button)
        ...
        ` 
        document.querySelectorAll('#btnEdit').forEach(e => {e.style.filter = '';e.style.opacity = ''})
        document.querySelectorAll('#btnRemove').forEach(e => {e.style.filter = '';e.style.opacity = ''})
        editOpen = false
        canDelete = true
    }
    ...
    // (Cancel button)
        ...
        `
        document.querySelectorAll('#btnEdit').forEach(e => {e.style.filter = '';e.style.opacity = '';e.style.cursor = ''})
        document.querySelectorAll('#btnRemove').forEach(e => {e.style.filter = '';e.style.opacity = '';e.style.cursor = ''})
        editOpen = false
        canDelete = true
    }
})