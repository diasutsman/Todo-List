...
display.addEventListener('click', (e) => {
    ...
    // (Save Button)
        ...
        ` 
        document.querySelectorAll('#btnEdit').forEach(e => {e.style.filter = '';e.style.opacity = 'pointer'})
        document.querySelectorAll('#btnRemove').forEach(e => {e.style.filter = '';e.style.opacity = 'pointer'})
        editOpen = false
        canDelete = true
    }
